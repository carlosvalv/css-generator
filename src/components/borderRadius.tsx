...
function BorderRadius() {
  ...
  useEffect(() => {
    const string = `${parseFloat(corner4.toString()).toFixed(1)}% ${parseFloat(
      (100 - corner4).toString(),
    ).toFixed(1)}% ${parseFloat((100 - corner2).toString()).toFixed(
      1,
    )}% ${parseFloat(corner2.toString()).toFixed(1)}%/${parseFloat(
      corner1.toString(),
    ).toFixed(1)}% ${parseFloat(corner3.toString()).toFixed(1)}% ${parseFloat(
      (100 - corner3).toString(),
    ).toFixed(1)}% ${parseFloat((100 - corner1).toString()).toFixed(1)}%`;
